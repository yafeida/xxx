...
import com.monkey.common.handler.ExportHandler;
import com.monkey.common.util.poi.convert.ExportConvert;
import com.monkey.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
    ...
    private void requiredbuilderParams() {
        if (mClass == null) {
            throw new IllegalArgumentException("请先使用com.monkey.util.ExcelUtils.builder(Class<?>)构造器初始化参数。");
        }
    }
    ...
    private void requiredexportParams() {
        if (mClass == null || mResponse == null) {
            throw new IllegalArgumentException(
                    "请先使用com.monkey.util.ExcelUtils.export(Class<?>, HttpServletResponse)构造器初始化参数。");
        }
