...
import com.monkey.common.util.vcode.Captcha;
import com.monkey.common.util.vcode.GifCaptcha;
import com.monkey.system.domain.User;
import com.monkey.system.service.UserService;
...
public class LoginController extends BaseController {
    ...
    public ResponseBo login(String username, String password, String code, Boolean rememberMe) {
        ...
        // 密码 MD5 加密
        String salt = this.userService.selectSaltByUsername(username.toLowerCase());
        password = MD5Utils.encrypt(username.toLowerCase(), password, salt);
    ...
    public void getGifCode(HttpServletResponse response, HttpServletRequest request) {
        try {
            ...
            Captcha captcha = new GifCaptcha(
            		monkeyProperies.getValidateCode().getWidth(),
            		monkeyProperies.getValidateCode().getHeight(),
            		monkeyProperies.getValidateCode().getLength());
