...
public class UserController extends BaseController {
    ...
    public boolean checkPassword(String password) {
        ...
        String salt = this.userService.selectSaltByUsername(user.getUsername().toLowerCase());
        String encrypt = MD5Utils.encrypt(user.getUsername().toLowerCase(), password, salt);
