...
import com.monkey.system.dao.UserMapper;
import com.monkey.system.dao.UserRoleMapper;
...
public class UserServiceImpl extends BaseService<User> implements UserService {
    ...
    public void registUser(User user) {
        ...
        String salt = MD5Utils.genSalt();
        user.setSalt(salt);
        user.setPassword(MD5Utils.encrypt(user.getUsername(), user.getPassword(), salt));
        this.save(user);
    ...
    public void updatePassword(String password) {
        ...
        String salt = MD5Utils.genSalt();
        user.setSalt(salt);
        String newPassword = MD5Utils.encrypt(user.getUsername().toLowerCase(), password, salt);
	...
	public String selectSaltByUsername(String username) {
		return this.userMapper.selectSaltByUsername(username);
	}
