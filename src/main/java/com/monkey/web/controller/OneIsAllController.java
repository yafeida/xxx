...
import com.monkey.common.util.MonkeyConstant;
import com.monkey.common.util.HttpUtils;
import com.monkey.web.domain.IdList;
...
public class OneIsAllController extends BaseController {
    ...
    public ResponseBo getOneList() {
        try {
            ...
            String data = HttpUtils.sendGet(MonkeyConstant.ONE_LIST_URL + id + "/0", STATIC_URL);
    ...
    public ResponseBo getYuwenDetail(String itemId, String id) {
        try {
            String data = HttpUtils.sendGet(MonkeyConstant.ONE_ESSAY_URL + itemId, "channel=wdj&source=summary&source_id="
    ...
    public ResponseBo getYuwenComments(String itemId) {
        try {
            String data = HttpUtils.sendGet(MonkeyConstant.ONE_ESSAY_COMMENT_URL + itemId + "/0", STATIC_URL);
            return ResponseBo.ok(data);
        } catch (Exception e) {
    ...
    public ResponseBo getEssayDetail(String itemId, String id) {
        try {
            String data = HttpUtils.sendGet(MonkeyConstant.ONE_ESSAY_URL + itemId,
    ...
    private static IdList getIdList() {
        ...
        try {
            String idList = HttpUtils.sendGet(MonkeyConstant.ONE_ID_LIST_URL, STATIC_URL);
