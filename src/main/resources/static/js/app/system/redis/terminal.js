var $MB_Redis_Bash = function () {
    $(document).ready(function () {
        ...
        printf("Last login: " + date + " on Monkey, type `help` for help\n");
        displayPrompt();
        ...
        function help(arg) {
            ...
            if (hasArgs(arg)) {
                ...
                printf(" Redis bash with SpringBoot by <a href='https://baidu.com' class='kw_b'>Monkey</a>, version v0.0.1 - Snapshot \n");
