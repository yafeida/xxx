...
/*当手机号为空或号段不支持时显示默认的面值，否则根据手机号查询出该号段配置的话费包循环遍历出查询的面值并显示
 *此处暂时设置为固定话费包，等待查询接口写完在做修改
 *http://118.31.229.23:8080/bosspaybill/order/getOrderPriceByPhone?phoneNo=18764166237&terminalName=newweixin&signature=cf49498d1046ec2c8b0130856d61bb93
 *目前此处功能为input标签为空则显示默认话费包，不为空显示配置的话费包
 * */
